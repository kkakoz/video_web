...
func (u *UserRepo) WithIds(ids []int64) gormx.DBOption {
	return func(db *gorm.DB) *gorm.DB {
...
func (u *UserRepo) Get(ctx context.Context, opts ...gormx.DBOption) (*domain.User, error) {
	db := mysqlx.GetDB(ctx)
	user := &domain.User{}
...
func (u *UserRepo) GetList(ctx context.Context, opts ...gormx.DBOption) ([]*domain.User, error) {
	db := mysqlx.GetDB(ctx)
